...
const baseTheme = createTheme({
  typography: {
    ...
    h1: { fontSize: '2.5rem',   fontWeight: tokens.typography.weightBlack, letterSpacing: '-0.02em' },
    ...
    body1:   { fontSize: '1rem',     fontWeight: tokens.typography.weightRegular, lineHeight: 1.5 },
    body2:   { fontSize: '0.875rem', fontWeight: tokens.typography.weightRegular, lineHeight: 1.4 },
    caption: { fontSize: '0.75rem',  letterSpacing: '0.08em', textTransform: 'uppercase' as const },
  },
  spacing: 8,
